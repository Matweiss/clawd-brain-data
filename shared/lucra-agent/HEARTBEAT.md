...
3. Before the morning briefing, run the daily competitor pulse once per weekday and include any material items
4. If 7 AM–7 PM PT: check for stale deals past thresholds, scan email for urgent threads
...
- One competitor pulse per weekday max
